...
public class StatusBarClockStyle extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createCustomView() {
        ...
        mFontStyle.setValue(Integer.toString(Settings.CMREMIX.getInt(getActivity()
                .getContentResolver(), Settings.CMREMIX.STATUSBAR_CLOCK_FONT_STYLE,
                4)));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            Settings.CMREMIX.putInt(getActivity().getContentResolver(),
                    Settings.CMREMIX.STATUSBAR_CLOCK_FONT_STYLE, val);
